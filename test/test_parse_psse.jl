...
@testset "PSSE transformer CM=2 magnetizing susceptance is inductive" begin
    ...
    cm2 = replace(
        raw,
        "   109,   104,     0,'1 ',1,1,1, 0.00000E+0, 0.00000E+0,2,'TRAFO 2W 3  '" =>
            "   109,   104,     0,'1 ',1,1,2, 3.00000E+4, 5.00000E-3,2,'TRAFO 2W 3  '",
        "   109,   104,   107,'1 ',1,1,1, 0.00000E+0, 0.00000E+0,2,'TRAFO 3W 2  '" =>
            "   109,   104,   107,'1 ',1,1,2, 3.00000E+4, 5.00000E-3,2,'TRAFO 3W 2  '",
    )
    @test cm2 != raw
...
@testset "PSSE transformer CM=2 zero MAG1/MAG2 warns on both winding counts" begin
    ...
    cm2 = replace(
        raw,
        "   109,   104,     0,'1 ',1,1,1, 0.00000E+0, 0.00000E+0,2,'TRAFO 2W 3  '" =>
            "   109,   104,     0,'1 ',1,1,2, 0.00000E+0, 0.00000E+0,2,'TRAFO 2W 3  '",
        "   109,   104,   107,'1 ',1,1,1, 0.00000E+0, 0.00000E+0,2,'TRAFO 3W 2  '" =>
            "   109,   104,   107,'1 ',1,1,2, 0.00000E+0, 0.00000E+0,2,'TRAFO 3W 2  '",
    )
    @test cm2 != raw
